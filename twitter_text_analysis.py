...
fig = px.bar(uni_grams, y='words', x="count", template='plotly_white', orientation='h')
...
fig = px.bar(bi_grams, y='words', x="count", template='plotly_white', orientation='h')
fig.update_layout(barmode='stack', yaxis={'categoryorder': 'total ascending'}, width=900, height=543)
st.plotly_chart(fig)
...
fig = px.bar(tri_grams, y='words', x="count", template='plotly_white', orientation='h')
fig.update_layout(barmode='stack', yaxis={'categoryorder': 'total ascending'},width=900, height=543)
st.plotly_chart(fig)
